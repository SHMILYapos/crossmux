...
void ChapterHtmlSlimParser::makePages() {
  ...
  // Extra paragraph spacing: 0=off, else 0.25x/0.5x/0.75x/1x/1.25x/1.5x line height.
  if (extraParagraphSpacing > 0) {
    constexpr float EXTRA_PARAGRAPH_SPACING_FACTORS[] = {0.0f, 0.25f, 0.5f, 0.75f, 1.0f, 1.25f, 1.5f};
